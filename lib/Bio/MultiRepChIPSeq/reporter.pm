...
END
	...
	elsif ( $self->exclude and $self->{progress}{control_peak} ) {
...
tracks as described above. If replicates were provided, their fragment coverage was
averaged together. The number of peaks identified are listed below.
...
Broad, gapped peaks were called for each sample from the sample fragment coverage and
enrichment tracks as described above. If replicates were provided, their fragment
coverage was averaged together. The number of peaks identified are listed below.
